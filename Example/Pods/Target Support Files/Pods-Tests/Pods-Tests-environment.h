...
// MultiStateButton
#define COCOAPODS_POD_AVAILABLE_MultiStateButton
#define COCOAPODS_VERSION_MAJOR_MultiStateButton 0
#define COCOAPODS_VERSION_MINOR_MultiStateButton 1
#define COCOAPODS_VERSION_PATCH_MultiStateButton 0
